...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  late Animation _animationColumns;
  ...
  void initState() {
    ...
    _animation = Tween(begin: 1.0, end: 2.0).animate(CurvedAnimation(
        parent: _animationScaleController, curve: Curves.elasticInOut));
  ...
  Widget build(BuildContext context) {
    Map<int, WidgetBuilder> pages = {
      ...
      1: (context) => AboutWidget(
            onPress: () => index.value = 0,
          )
    };
    ...
    return Obx(() {
      return PageTransitionSwitcher(
        ...
        child: pages[index.value]!(context),
      );
    });
  }
    ...
    return ScaleTransition(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          _animationScaleController
              .forward()
              .then((_) => _animationScaleController.reverse());
        },
        child: AspectRatio(
          aspectRatio: 720 / 438,
